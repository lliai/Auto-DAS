...
class Interaction:
    ...
    def gen_all(search_space, num, return_ori):
        ...
        if return_ori:
            ...
            return [Interaction(x) for x in all_archs]


ResNet_CODE = Interaction([
