...
def init(model_s, model_t, init_modules, criterion, train_loader, logger, opt):
    ...
    if opt.model_s in ['resnet8', 'resnet14', 'resnet20', 'resnet32',
                       'resnet44', 'resnet56', 'resnet110',
                       'resnet8x4', 'resnet32x4', 'wrn_16_1', 'wrn_16_2',
                       'wrn_40_1', 'wrn_40_2'] and \
            opt.distill == 'factor':
        lr = 0.01
    else:
        ...
        for idx, data in enumerate(train_loader):
            ...
            if opt.distill == 'abound':
                ...
                raise NotImplementedError(
                    f'Not supported in init training: {opt.distill}')
