...
from diswotv2.datasets.base import BaseDataset
...
class Cifar100(BaseDataset):
    ...
    def __init__(self,
        ...
        super(Cifar100, self).__init__(split, offline, feature_file, mean, std,
                                       img_size, strong_augmentation)
...
def get_cifar100_dataloaders(data_folder, batch_size=128, num_workers=4):
    """
    cifar 100
    """
...
def vit_cifar100_dataloaders(data_folder,
                             batch_size=128,
                             num_workers=0,
                             img_size=224):
    """
