...
from diswotv2.api.nas101_api import get_nb101_model
...
from diswotv2.models.util import (Connector, ConvReg, Embed, LinearEmbed,
...
def parse_option():
    ...
    parser.add_argument(
        '--arch_hash', default=None, type=str, help='arch hash')
...
def main():
    ...
    if opt.dataset == 'cifar100':
        ...
        from diswotv2.models.nasbench201.utils import (CellStructure,
                                                       dict2config,
        ...
        # resnet110
        from diswotv2.models.candidates.fixed_models import tresnet110
