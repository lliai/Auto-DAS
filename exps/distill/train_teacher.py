...
from diswotv2.helper.loops import train_vanilla as train
from diswotv2.helper.loops import validate
from diswotv2.helper.util import AverageMeter, accuracy, adjust_learning_rate
...
def parse_option():
    ...
    parser.add_argument(
        '--log_interval', type=int, default=100, help='print frequency')
    parser.add_argument(
    ...
    parser.add_argument(
        '-t', '--trial', type=int, default=0, help='the experiment id')
