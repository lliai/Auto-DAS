...
def parse_option():
    ...
    parser.add_argument(
        ...
        help='dataset')
    parser.add_argument(
        '--data_folder', type=str, default='./data', help='data folder')
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            'kdsvd', 'fsp', 'rkd', 'pkt', 'abound', 'factor', 'nst'
        ])
    ...
    opt.model_name = f'S~{opt.model_s}_T~{opt.model_t}_{opt.dataset}_{opt.distill}_r~{opt.gamma}_a~{opt.alpha}_b~{opt.beta}_{opt.trial}'
